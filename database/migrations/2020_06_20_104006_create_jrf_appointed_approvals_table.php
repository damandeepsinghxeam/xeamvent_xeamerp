...
class CreateJrfAppointedApprovalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('jrf_appointed_approvals', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('jrf_appointed_approvals');
    }
}
