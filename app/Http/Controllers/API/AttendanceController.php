...
class AttendanceController extends Controller
{
    ...
    */
    ...
    function EmpThreeDaysAttendance(Request $request)
    {
        ...
        $attendances = Attendance::where(['user_id' => $auth_user->id])
        ...
        foreach($attendances as $attendance) {
            ...
            if(isset($first_punch)) {
                ...
                $attendance->first_punch_type = $first_punch->type;
            } else {
            ...
            if(isset($last_punch)) {
                ...
                $attendance->last_punch_type = $last_punch->type;
            } else {
                $attendance->last_punch = "N/A";
            }

            $attendance->on_date = date("d M, Y", strtotime($attendance->on_date));
