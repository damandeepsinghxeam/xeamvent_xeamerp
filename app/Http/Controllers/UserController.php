...

{
    ...
    */
    function createPermission()
    {
        ...
        $user = User::find(1);
        $user->givePermissionTo(['task-report']);
    ...
    */
    function edit($user_id,$tabname = null)
    {
        ...
        if(isset($employeeSalaryStructure)){
            $data['restrict_employee_share'] = $employeeSalaryStructure->restrict_employee_share;
            $data['restrict_employer_share'] = $employeeSalaryStructure->restrict_employer_share;
            ...
            $data['restrict_employee_share'] = '';
            $data['restrict_employer_share'] = '';
            $data['lwf_applied'] = '';
