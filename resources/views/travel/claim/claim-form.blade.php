        ...
        <form id="claim-form" accept="" action="" method="post" enctype="multipart/form-data">
          ...
          <div class="box box-primary">
            <h2 class="travel-expense-title2">
              ...
              <legend>
                Purpose: {{$approval->travel_purpose}}
              </legend>
            </h2>
            <h4 class="p-w-xs">
              <small>
                <a href="{{url('travel/approval-request-details/'.encrypt($approval->id))}}" class="btn btn-success btn-xs">View Details</a>
              </small>
            </h4>
            ...
            <div class="box-body">
                ...
                <div class="col-md-12 table-responsive no-padding">
                  <table id="" class="table table-bordered table-striped travel-table-inner" style="height:150px;">
                    ...
                    <tbody id="travelExpenseTable">
                        <tr>
                          <td>
                            <input type="text" name="travel_expense[date][]" class="form-control selectDate travel-table-input-style travel-only-inputss travel-input2 travelDate" value="" required onkeypress="return false;" placeholder="MM/DD/YYYY" autocomplete="off">
                          </td>
                          <td>
                          ...
                          <td>
                            <input type="number" name="travel_expense[amount][]" class="form-control travel-input5 travel-table-input-style travel-only-inputss amount_to_be cal_value" required max="20000" min="1" placeholder="330">
                          </td>
                          <td class="text-center">
                            <a href="javascript:void(0);" class="addtravel">
                    ...
                    <table class="table table-bordered table-striped">
                      ...
                      <tbody id="tbody">
                        <tr class="city_tr">
                          ...
                          <td>
                            <input type="number" name="stay[da][]" class="form-control amount_to_be stayda da_class da cal_value" min="0" value="0" placeholder="DA" required autocomplete="off">
                          </td>
                          <td>
                            <a href="javascript:void(0);" onclick="addMoreStay()">
                              <i class="fa fa-plus addtravel-row"></i>
                            </a>
                          </td>
                        </tr>
              ...
              <div class="row">
                <div class="col-md-12 text-center">
                  @if(!isset($claims->id)) 
                    <input type="submit" name="submit_btn" class="btn btn-success btn-submit" value="Submit">
                  @elseif($claims->status=='back')
                    <input type="submit" name="update_btn" class="btn btn-success btn-submit" value="Update & Submit">
                  @else
...
<div class="hide" id="cloneit">
  ...
  <table>
    <tr id="city_tr" class="removetr city_tr">
      ...
      <td>
        <input type="number" name="stay[rate_per_night][]" class="form-control stayda amount_to_be rate_per_night cal_value" min="0" value="0" placeholder="Rate per night" required>
      </td>
      <td>
      ...
      <td>
        <a href="javascript:void(0);" onclick="removeThisTr($(this))">
          <i class="fa fa-minus remtravel-row"></i>
        </a>
      </td>
    </tr>
