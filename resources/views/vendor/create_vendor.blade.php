	                 ...
	                 <div class="col-md-6">
	                    ...
	                    <div class="form-group">
	                       ...
	                       <div class="row">
	                          ...
	                          <div class="col-md-8 col-sm-8 col-xs-8 leave-input-box input-470">
	                             <input type="text" class="form-control input-md basic-detail-input-style input_1" name="designation_of_contact_person" id="designation_of_contact_person" placeholder="Designation Of Contact Person">
	                          </div>
	                       </div>
	                    </div>
