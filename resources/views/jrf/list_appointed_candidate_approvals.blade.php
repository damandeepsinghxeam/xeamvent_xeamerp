...
<div class="content-wrapper">
  <section class="content-header">
      <h1><i class="fa fa-list"></i> Apointed Candidates Approval List</h1>
      <ol class="breadcrumb">
              ...
              <div class="box-body">
                <div class="dropdown m-b-sm">
                    ...
                    <ul class="dropdown-menu">
                      <li><a href='{{url("jrf/approve-appointed-candidate/pending")}}'>Pending</a></li>
                      <li><a href='{{url("jrf/approve-appointed-candidate/assigned")}}'>Approved</a></li>
                      <li><a href='{{url("jrf/approve-appointed-candidate/rejected")}}'>Rejected</a></li>
                    </ul>
                </div>
                ...
                <table id="listLeaveApproval" class="table table-bordered table-striped text-center" style="height:150px;">
                    ...
                    @if(!@$data->isEmpty())
                      ...
                      <tr>
                        ...
                        <td><a  href='{{url("jrf/view-jrf/$value->jrf_id")}}'>{{@$value->jrf_no}}</a></td>
                        ...
                        <!--<td>
                          <a class="btn btn-primary" target="_blank" href='{{ url("jrf/view-appointment-approval/$value->jrf_level_one_screening_id")}}'>View</a>
                        </td> -->
                        <td>
                          <div class="dropdown">
                          @if($value->closure_type == 'open')  
                          @if($value->final_status == '0' || $value->final_status == '1' && $value->jrf_status == '0')
                          ...
                          @endif
                           @elseif($value->closure_type == 'hold')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <form id="jrfStatusForm" action="{{url('jrf/save-appointed-candidate-approval') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="box-body">
