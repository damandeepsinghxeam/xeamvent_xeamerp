          ...
          <div class="container-fluid border">
              ...
              <div class="main-content mx-5" style="min-height: 1000px;">
                <div class="row justify-content-between mx-5">
                  <span>To,</span>
                  <span><b>Date:</b> {{@$offer_letter->joining_date}}</span>
                </div>
                <p class="mx-5">
                  <span class="d-block">Mr./Mrs. {{@$offer_letter->cand_name}}</span>
                ...
                <div class="al-content mt-5 mx-5 mb-5 text-justify">
                  ...
                  <p class="mt-5">Dear Mr./Mrs. <b>{{@$offer_letter->cand_name}}</b></p>
                  <p>We <b>(M/s XEAM Ventures Pvt. Ltd.)</b> are pleased to offer you appointment as <b>“{{@$offer_letter->current_designation}}”</b> w.e.f. <b>{{@$offer_letter->joining_date}}</b> in our organization. The terms and conditions of your appointment are detailed in this Appointment Letter and any subsequent change/ modification applicable to employees that come into effect from time to time shall form the part of this Appointment Letter as an addendum.</p>
               </div>
              </div>
