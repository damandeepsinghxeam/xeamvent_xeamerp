                        ...
                        <div class="col-md-7">
                          <div class="table-styling">
                            ...
                            <table class="table table-striped table-responsive">
                             ...
                             <tr>
                               <th>TRAINING PERIOD <br>(IF HIRED AS TRAINEE):</th>
                               <td>
                             ...
                             <tr>
                               ...
                               <td>
                                 <input type="text" name="probation_period" id="" class="form-control basic-detail-input-style" placeholder="Enter Probation Period here">
                               </td>
                             </tr>
                             <tr>
                               <th>SECURITY:</th>
