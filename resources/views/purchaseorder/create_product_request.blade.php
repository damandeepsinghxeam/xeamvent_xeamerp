	              ...
	              <div class="row">
	                      	...
	                      	<div class="form-group">
	                           	<div class="row">
	                              	<div class="col-md-4 col-sm-4 col-xs-4 leave-label-box label-470">
	                                	<label for="product_name" class="apply-leave-label">Select Product Item<sup class="ast">*</sup></label>
	                              	</div>
	                              	<div class="col-md-8 col-sm-8 col-xs-8 leave-input-box input-470">

									<select class="form-control select2 input-sm basic-detail-input-style" name="product_name" style="width: 100%;" id="product_name" data-placeholder="Select Product Item ">
	                 ...
	                 <div class="col-md-6">
						...
						<div class="form-group">
	                       <div class="row">
	                          <div class="col-md-4 col-sm-4 col-xs-4 leave-label-box label-470">
							  <label for="no_of_items_requested" class="apply-leave-label">Enter Number Of Product Items<sup class="ast">*</sup></label>
	                          </div>
	                          <div class="col-md-8 col-sm-8 col-xs-8 leave-input-box input-470">
							  <input autocomplete="off" type="text" class="form-control input-sm basic-detail-input-style" name="no_of_items_requested" id="no_of_items_requested" placeholder="Please Enter Numbers Of Requested Items.">
	                          </div>
	                       </div>
	                    </div>
