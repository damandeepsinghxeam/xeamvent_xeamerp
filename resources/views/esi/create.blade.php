                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row col-md-12">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="employee_percent" id="" class="form-control experiencedata regis-input-field only_numeric">
                                        </div>

                                        <div class="col-md-4">
                                            <label for="name" class="basic-detail-label">Employer(%)<span style="color: red">*</span></label>
                                            <input type="text" name="employer_percent" id="" class="form-control experiencedata regis-input-field only_numeric">
                                        </div>

                                        <div class="col-md-4">
                                            <label for="name" class="basic-detail-label">Cut Off</label>
                                            <input type="text" name="cutoff" id="" class="form-control experiencedata regis-input-field only_numeric">
                                        </div>
